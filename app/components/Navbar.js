...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-[200] md:hidden flex flex-col transition-all duration-300"
        style={{
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at top right, rgba(23,168,160,0.12) 0%, transparent 65%)",
          }}
        />
        {/* Bottom-left glow */}
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at bottom left, rgba(23,168,160,0.06) 0%, transparent 65%)",
          }}
        />
          ...
          {links.map((l, i) => (
            ...
            >
              <div className="flex items-baseline gap-4">
                ...
                <span
                  className="font-bold leading-none transition-colors duration-200 group-hover:text-white"
                  style={{
                    fontSize: "clamp(2rem, 9vw, 2.8rem)",
                    color: pathname === l.href ? "#fff" : "#4B5563",
                  }}
                >
                  {l.label}
                </span>
